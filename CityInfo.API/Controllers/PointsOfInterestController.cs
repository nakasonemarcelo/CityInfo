...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : ControllerBase
    {
            ...
            int cityId, int pointOfInterestId)
        {
            ...
            var pointOfIneterest = await _cityInfoRepository
                .GetPointOfInterestForCityAsync(cityId, pointOfInterestId);

            if (pointOfIneterest == null) 
            {
                return NotFound();
            }

            return Ok(_mapper.Map<PointOfInterestDto>(pointOfIneterest));
            ...
            int cityId, int pointOfInterestId)
        {
            ...
            _mailService.Send("Poin of interest deleted.", 
